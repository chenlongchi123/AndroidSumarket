...
import java.util.Map;
    ...
    public class GetAllLessActivity extends AppCompatActivity {
        SimpleAdapter adapter = null;
        ListView lvGetAllLess=null;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_get_all_less);
            lvGetAllLess=(ListView)findViewById(R.id.lvGetAllLess);
            ...
            // from: Map中的key
            // to: 布局中的组件id
            adapter = new SimpleAdapter(this, data, R.layout.activity_item_get_all_less,
                    new String[] { "name", "price", "num", "id","type"}, new int[] {R.id.tvName, R.id.tvPrice, R.id.tvNum,R.id.tvId,R.id.tvType });
            // 绑定
            lvGetAllLess.setAdapter(adapter);
            // 事件处理
        ...
        protected void onResume() {
            ...
            super.onResume();
            if (!NetUtils.check(com.chen.supermarketmanagement.GetAllLessActivity.this)) {
                Toast.makeText(com.chen.supermarketmanagement.GetAllLessActivity.this,
            ...
            // 进度对话框
            pDialog=ProgressDialog.show(com.chen.supermarketmanagement.GetAllLessActivity.this,null,"正在连接...",false,true);
            ...
            public void handleMessage(android.os.Message msg) {
                ...
                switch (msg.what) {
                    case 1:
                        ...
                        break;
                    case 2:
                        Toast.makeText(com.chen.supermarketmanagement.GetAllLessActivity.this, "服务器错误，请重试",
                                Toast.LENGTH_SHORT).show();
                        break;
                    case 3:
                        Toast.makeText(com.chen.supermarketmanagement.GetAllLessActivity.this, "请重新登录",
                                Toast.LENGTH_SHORT).show();
                        break;
                }
